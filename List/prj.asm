...
; 0000 002C // Func2=In Func1=In Func0=In
; 0000 002D // State2=T State1=T State0=T
...
; 0000 0041 // OC0A output: Disconnected
; 0000 0042 // OC0B output: Disconnected
; 0000 0043 TCCR0A=0x00;
	OUT  0x30,R30
; 0000 0044 TCCR0B=0x00;
	OUT  0x33,R30
; 0000 0045 TCNT0=0x00;
	OUT  0x32,R30
; 0000 0046 OCR0A=0x00;
	OUT  0x36,R30
; 0000 0047 OCR0B=0x00;
	OUT  0x3C,R30
; 0000 0048 
